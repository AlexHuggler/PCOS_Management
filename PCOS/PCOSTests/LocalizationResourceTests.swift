...
struct LocalizationResourceTests {
    ...
    private let onboardingKeys = [
        ...
        "Nutrition values can vary by preparation, portion size, hidden oil, sauce, or dressing. Review and edit every estimate before saving. Barcode scanning and manual entry remain available if photo analysis is unavailable or your fresh-analysis allowance is used.",
